...
> {
  children?:
    | ((params: T extends DefaultParams ? T : RouteParams<RoutePath>) => Child)
    | Child;
  path?: RoutePath;
  component?: FC<
...
export function Route<
  T extends DefaultParams | undefined = undefined,
  RoutePath extends Path = Path
>(props: RouteProps<T, RoutePath>): ReturnType<FC>;
...
type HTMLLinkAttributes = Omit<Hono.HTMLAttributes, "className"> & {
...
export type LinkProps<H extends BaseLocationHook = BrowserLocationHook> =
  NavigationalProps<H> &
    AsChildProps<
      { children: Child; onClick?: (event: MouseEvent) => void },
      HTMLLinkAttributes
    >;
